...
from utils.datasets.entities_name import msl_entities

class Msl_entity(Dataset):

    def __init__(self, seed: int, data_path='datasets', entity="C-1", remove_unique=False, verbose=False):
        """
        ...
        #                             "datasets", "smap_msl")
        self.base_path = os.path.join(data_path, "smap_msl")
        self.seed = seed
...
def main():
    ...
    seed = 0
    smap = Msl_entity(seed=seed, remove_unique=False)
